...
Create a directory for your app's code on your local file system. Make a directory `docker` inside it. Copy the template [.packagerun](/templates/.package) directory and the template [main script](/templates/script/main) to this `docker` directory.
