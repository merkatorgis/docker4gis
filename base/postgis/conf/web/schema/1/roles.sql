create role web_authenticator noinherit login password 'postgrest';

create role web_anon nologin;
grant web_anon to web_authenticator;
grant usage on schema web to web_anon;

create role web_passwd nologin;
grant web_passwd to web_authenticator;
grant usage on schema web to web_passwd;
...
grant usage on schema web to web_admin;
